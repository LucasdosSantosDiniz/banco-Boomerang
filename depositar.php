...
<body>
    ...
    <div class="container">
        <div id="operacoes">
            <h2 class="titulo-operacoes">DESEJA DEPOSITAR QUANTO <?php echo $dados ['nome']; ?></h2>
            <fieldset>
                <form method="post" action="depositar_conta.php">
                    <input type="number" name="deposito" id="deposito" placeholder = " R$ 0,00"><br><br>
